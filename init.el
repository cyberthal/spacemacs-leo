...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(mixed-pitch easy-hugo gnu-elpa-keyring-update command-log-mode dired-filter gif-screencast lispy dired-du org-make-toc bbcode-mode magit-annex git-annex outshine flycheck-package)
