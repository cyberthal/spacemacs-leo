...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(gnu-elpa-keyring-update command-log-mode dired-filter gif-screencast anzu lispy dired-du org-make-toc bbcode-mode magit-annex git-annex dired-quick-sort outshine flycheck-package)
