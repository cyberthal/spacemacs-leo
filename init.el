...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(anzu lispy dired-du org-make-toc bbcode-mode magit-annex git-annex dired-quick-sort outshine flycheck-package)
